...
void CClientLogView::OnClickLockScreen(wxCommandEvent&)
{
...
void CClientLogView::OnClickClear(wxCommandEvent&)
{
...
void CClientLogView::OnClickFlush(wxCommandEvent&)
{
	OnSwitchTo(GetCurrentClient());
}

void CClientLogView::OnClickRetry(wxCommandEvent&)
{
