...
public:
	...
	virtual void OnSwitchTo(_U32 index) { (void)index; }
	virtual void OnClear() { }
	virtual void OnNewClient(_U32 index) { (void)index; }
	virtual void OnNewCase(_U32 index, Zion::CStressCase* pCase) { (void)index; (void)pCase; }
