...
*/
void CClientDataView::OnNewClick(wxCommandEvent&)
{
	_U32 index = GetCurrentClient();
	if(index==(_U32)-1) return;
	Zion::CDataSyncClient* pClient = Zion::CStressManager::Get().GetClient(index)->GetClient()->GetDataSync();
...
void CClientDataView::OnSaveClick(wxCommandEvent&)
{
	_U32 index = GetCurrentClient();
	if(index==(_U32)-1) return;
	Zion::CDataSyncClient* pClient = Zion::CStressManager::Get().GetClient(index)->GetClient()->GetDataSync();
...
void CClientDataView::OnCancelClick(wxCommandEvent&)
{
	_U32 index = GetCurrentClient();
	if(index==(_U32)-1) return;
	Zion::CDataSyncClient* pClient = Zion::CStressManager::Get().GetClient(index)->GetClient()->GetDataSync();
...
void CClientDataView::OnDeleteClick(wxCommandEvent&)
{
	_U32 index = GetCurrentClient();
	if(index==(_U32)-1) return;
	Zion::CDataSyncClient* pClient = Zion::CStressManager::Get().GetClient(index)->GetClient()->GetDataSync();
...
void CClientDataView::OnSwitchTo(_U32)
{
	ClearEditor();
	FlushObjectList();
}
