...
namespace Zion
{
	...
	*/
	typedef zion_function<void(const JsonValue&)>	JSON_RESPONSE_PROC;
	typedef zion_function<void(const JsonValue*)>	JSON_CALLBACK_PROC;
	...
	void JsonRPC_StopClient(CJsonRPCClient* client);
