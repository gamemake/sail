...
namespace Zion
{
	...
	{
		m_StubBinary = ZION_NEW DDLStub::DATASYNC_BINARY_S2C<CDataSyncClient>(this);
		m_StubJson = ZION_NEW DDLStub::DATASYNC_JSON_S2C<CDataSyncClient>(this);

		pClient->RegisterStub(m_StubBinary);
		pClient->RegisterStub(m_StubJson);
		m_Flag = (_U32)-1;
	...
	{
		Clear();
		ZION_DELETE m_StubBinary;
		ZION_DELETE m_StubJson;
	}
	...
	LiveData::CManager& CDataSyncClient::GetAccesser()
	{
		return m_Accesser;
	}
