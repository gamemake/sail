...
#define zion_function		std::tr1::function
#define zion_bind			std::tr1::bind
#define zion_placeholders	std::tr1::placeholders
#else
#include <functional>
#define zion_function		std::function
#define zion_bind			std::bind
#define zion_placeholders	std::placeholders
#endif
...
namespace Zion
{
	...
	template<class _Ty>
	class Stack : public std::stack < _Ty, std::deque<_Ty, ZionSTLAlocator<_Ty> > >
	{
